...
- **THEN** Notes and Discount Percentage use the order's explicit editability rules, persist the visible control value on change or blur and remain isolated from other dish editors
