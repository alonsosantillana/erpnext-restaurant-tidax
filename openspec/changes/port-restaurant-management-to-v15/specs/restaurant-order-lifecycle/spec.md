...
- **THEN** Notes and Discount Percentage use the order's explicit editability rules and an explicit Save changes action validates and returns the server-persisted line
